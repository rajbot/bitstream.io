...
[B&#9837; Buddha Machine](http://tikirobot.net/BbBuddha/)                             | A javascript Buddha Machine based on the magical "[In B flat](http://inbflat.net)" project. The YouTube API requires flash be enabled. ([github](https://github.com/rajbot/Bb-Buddha-Machine))
